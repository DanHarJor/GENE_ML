...
if __name__ == '__main__':
    ...
    # ssh_path = None
    # ssh_path = 'lumi:/scratch/project_462000451/gene_out/ped2_safescan/scanfiles0012/scan.log'
    remote_path = "/scratch/project_462000451/gene_out/gene_auto/testing_batchscans"
    host = 'lumi'
    #data_set = ScanData('100_3p', parser, ssh_path=ssh_path)
    data_set = ScanData('testing_batchscans2', parser, host, remote_path=remote_path)
