...
conda activate gene_ml && pip install GPy==1.13.1 && pip install sparseSpACE=1.1.0 && pip install pysgpp-3.3.1 && pip install scp-0.15.0 $$ pip install scikit-activeml
